...
legend_labels1 = {'$C_L$ primal','$C_L$ primal (reconstructed)','$C_L$ corr. (k-exact)','$C_L$ corr. (CWENO)'};
legend_labels2 = {'$C_D$ primal','$C_D$ primal (reconstructed)','$C_D$ corr. (k-exact)','$C_D$ corr. (CWENO)'};
...
name ='CL_CD_error_anim_ic20_CWENO';
