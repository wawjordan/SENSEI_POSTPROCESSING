%% Force History File Reading (01/23/2025)
clc; clear; close all; fclose('all');
file_dir = 'C:\Users\wajordan\Desktop\JOUKOWSKI_C_GRID_curved_2025-02-12_09.01.33_OLD_STENCILS';
file_dir = 'C:\Users\wajordan\Desktop\JOUKOWSKI_C_GRID_curved_2_2025-02-12_09.01.45_NEW_STENCILS';

sub_dir1 = '_kt0257x0065';
sub_dir2 = '_kt0513x0129';
sub_dir3 = '_kt1025x0257';
sub_dir4 = '_kt2049x0513';
% sub_dir1 = '_kt2049x0513';
% sub_dir2 = '_kt2049x0513_no-flow-iter';
% sub_dir3 = '_kt2049x0513_no-bc-constraints';
% sub_dir4 = '_kt2049x0513_no-bc-constraints-no-flow-iter';
...
alpha = 5;
[CL_ex1,CL_pri1,CL_ic1,~,~,~] = get_data_from_sub_dir(file_dir,sub_dir1,exact_file,primal_file,ic_file,alpha);
[CL_ex2,CL_pri2,CL_ic2,~,~,~] = get_data_from_sub_dir(file_dir,sub_dir2,exact_file,primal_file,ic_file,alpha);
[CL_ex3,CL_pri3,CL_ic3,~,~,~] = get_data_from_sub_dir(file_dir,sub_dir3,exact_file,primal_file,ic_file,alpha);
[CL_ex4,CL_pri4,CL_ic4,~,~,~] = get_data_from_sub_dir(file_dir,sub_dir4,exact_file,primal_file,ic_file,alpha);
