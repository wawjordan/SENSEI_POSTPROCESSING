%% Parsing SVF data for SciTech (01/14/2026)
clc; clear; close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
foldernames1 = [foldernames1,'SVF_2026-01-14_20.42.31_CURVED_p4_q6_q6_hoex_TT_BC_subsonic_geo4'];           % 11
foldernames1 = [foldernames1,'SVF_2026-01-14_20.57.18_CURVED_p4_q6_q6_hoex_TT_BC_subsonic_geo4_10subiter']; % 12

foldernames1 = [foldernames1,'SVF_2026-01-14_20.14.59_CURVED_p4_q6_q6_hoex_TT_BC_supersonic'];      % 13
foldernames1 = [foldernames1,'SVF_2026-01-14_20.34.54_CURVED_p4_q6_q6_hoex_TT_BC_supersonic_geo4']; % 14
foldernames1 = [foldernames1,'SVF_2026-01-14_20.21.52_CURVED_p4_q6_q6_hoex_TT_supersonic'];         % 15
foldernames1 = [foldernames1,'SVF_2026-01-14_20.30.48_CURVED_p4_q6_q6_hoex_TT_supersonic_geo4'];    % 16

foldernames1 = cellfun(@(str_b)strcat(DATA_DIR,str_b),foldernames1,UniformOutput=false);



% foldernames = foldernames1([1,8,9]);
% var_select    = [ 3, 4, 4 ];
% var_mask      = {[ 1, 1, 1, 1 ]};
% norm_select   = [1];
% iter_select   = {[],[],[]};
...
foldernames = foldernames1([9,9,12]);
var_select    = [ 3, 4, 4 ];
var_mask      = {[ 1, 1, 1, 1 ]};
norm_select   = [1];
iter_select   = {[],[0],[0]};
...
post_plot_commands = {"set(hfig1.Children(4),'Ylim',[1e-14,1e-2]);",...
                      "yticks(hfig1.Children(4),10.^(-14:1:-2));",  ...
