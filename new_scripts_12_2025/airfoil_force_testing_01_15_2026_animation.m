...
err_var_ete_1_1    = abs([DATA1.H(:).(['ete_',var])]-airfoil.(var));
err_var_ete_2_1    = abs([DATA2.H(:).(['ete_',var])]-airfoil.(var));
...
target_folder = 'C:\Users\wajordan\Desktop\SciTech_Plots\ERR_CL';
